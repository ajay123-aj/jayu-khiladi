...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-whatsapp px-4 py-3 font-semibold text-white shadow-xl shadow-whatsapp/30 transition hover:-translate-y-0.5 hover:bg-whatsapp-dark"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
